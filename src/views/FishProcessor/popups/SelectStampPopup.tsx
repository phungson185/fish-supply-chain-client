...
const Stamp1 = ({ item }: { item: FishProcessingType }) => {
  return (
    <div id='stamp1'>
      ...
      <div className='bg-primary-main h-20 w-72 rounded-b-3xl p-3 flex justify-center'>
        <div className='text-white font-bold text-3xl p-2 rounded-2xl'>{item.processedSpeciesName}</div>
      </div>
    </div>
  );
};

const Stamp2 = ({ item }: { item: FishProcessingType }) => {
  return (
    <div id='stamp2'>
      <div
      ...
      >
        <div className='bg-white p-4 rounded-3xl'>
          <div className='flex flex-col items-start mb-5'>
            <div className='text-2xl font-bold'>{item.processedSpeciesName}</div>
            <div>Produced at {item.fishProcessor.name}</div>
